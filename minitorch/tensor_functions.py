...
class Sigmoid(Function):
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tensor:
        ...
        one_sub_sigmoid_t1 = 1 - sigmoid_t1
        prod = grad_output.f.mul_zip(sigmoid_t1, one_sub_sigmoid_t1)
        return grad_output.f.mul_zip(prod, grad_output)
...
class Permute(Function):
    ...
    def forward(ctx: Context, a: Tensor, order: Tensor) -> Tensor:
        ...
        return a._new(a._tensor.permute(*order.to_numpy().astype(int)))
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tuple[Tensor, float]:
        ...
        inv_order = np.empty_like(order_arr)
        for i, val in enumerate(order_arr):
            inv_order[int(val)] = i
        return grad_output._new(grad_output._tensor.permute(*inv_order.astype(int))), 0.0
